...
-- Bu dosya deployment sırasında otomatik çalıştırılır
...
-- Soruları kontrol et ve ekle (eğer yoksa)
...
-- Ek soruları ekle (KASA - PAKET / PAZARYERİ kategorisi)
INSERT IGNORE INTO field_inspection_questions (category_id, question_text, points, is_critical, point_deduction, description) VALUES
...
-- Ek soruları ekle (RESTORAN TEMİZLİK VE DÜZEN kategorisi)
INSERT IGNORE INTO field_inspection_questions (category_id, question_text, points, is_critical, point_deduction, description) VALUES
...
-- Ek soruları ekle (EKİPMAN BAKIMLARI kategorisi)
INSERT IGNORE INTO field_inspection_questions (category_id, question_text, points, is_critical, point_deduction, description) VALUES
...
-- Ek soruları ekle (RESTORAN HİZMET VE KALİTE STANDARTLARI kategorisi)
INSERT IGNORE INTO field_inspection_questions (category_id, question_text, points, is_critical, point_deduction, description) VALUES
...
-- Soruların silinmesini önlemek için trigger oluştur (isteğe bağlı)
-- Bu trigger, kritik soruların yanlışlıkla silinmesini engeller
DELIMITER //
...
BEGIN
  IF OLD.is_critical = 1 THEN
    ...
    SET MESSAGE_TEXT = 'Kritik sorular silinemez. Lütfen admin ile iletişime geçiniz.';
  END IF;
END//
DELIMITER ;
