...
// SQL ile kategorileri ve soruları ekle
...
await db.execute('DELETE FROM position_questions WHERE category_id IN (SELECT id FROM position_categories WHERE position_id = 6)');
await db.execute('DELETE FROM position_categories WHERE position_id = 6');
