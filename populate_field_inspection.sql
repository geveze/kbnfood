...
-- Kategorileri ekle
INSERT INTO field_inspection_categories (id, name, weight, description, order) VALUES
(1, '1. IZGARA / PİŞİRME', 15, 'Izgara işletme ve pişirme standartları', 1),
(2, '2. TAVUK ÜRÜNLERİ', 15, 'Tavuk ürünleri hazırlama ve sunumu', 2),
(3, '3. KASA / PAKET', 10, 'Kasa ve paketleme işlemleri', 3),
(4, '4. PAZARYERLERI', 10, 'Pazaryeri operasyonları', 4),
(5, '5. İÇECEK / LEMONAT', 5, 'İçecek ve lemonat hazırlama', 5),
(6, '6. RESTORAN ORTAMI', 10, 'Restoran ortamı ve temizlik', 6),
(7, '7. PERSONEL', 10, 'Personel yönetimi ve davranışı', 7),
(8, '8. KALİTE / ÜRÜN', 10, 'Ürün kalitesi kontrol', 8),
(9, '9. HİJYEN / GIDA GÜVENLİĞİ', 15, 'Hijyen ve gıda güvenliği standartları', 9);
